...
class RToolBar: UIView {
    ...
    open var toolbar: UIToolbar {
        ...
        let toolBarTitleItem = toolBarL.titleItem(text: "", font: UIFont(name: "FSLucas-Medium", size: 15.0)!, color: UIColor.black)
...
class ToolBar: UIToolbar {
    ...
    func appendButton(buttonItem: UIBarButtonItem) {
        ...
        buttonItem.setTitleTextAttributes([
            NSAttributedString.Key.font: UIFont(name: "FSLucas-Medium", size: 14.0)!,
