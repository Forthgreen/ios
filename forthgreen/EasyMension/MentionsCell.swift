    ...
    var mentionItem : MentionItem? {
        didSet{
          //  nameLabel.text = mentionItem?.name
            userNameLabel.text = mentionItem?.name
            avatar.downloadCachedImage(placeholder: GLOBAL_IMAGES.placeholderForProfile.rawValue, urlString: mentionItem?.imageUrl ?? "")
        }
    }
...
//        nameLabel.translatesAutoresizingMaskIntoConstraints = false
        ...
        avatar.topAnchor.constraint(equalTo: self.contentView.topAnchor,constant: 10).isActive = true
        avatar.bottomAnchor.constraint(equalTo: self.contentView.bottomAnchor, constant: -10).isActive = true
        ...
        userNameLabel.topAnchor.constraint(equalTo: self.contentView.topAnchor,constant: 18).isActive = true
